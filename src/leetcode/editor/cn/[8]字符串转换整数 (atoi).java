...
class Atoi8 {
    public int myAtoi(String s) {
        ...
        int operator = isMinus ? -1 : 1;
        return Integer.parseInt(tmp) * operator;
    }

    boolean check(boolean isMinus, String s) {
        String operator = "";
        if (isMinus) operator = "-";
        return Long.parseLong(operator + s) <= Integer.MIN_VALUE ||
                Long.parseLong(operator + s) >= Integer.MAX_VALUE;
